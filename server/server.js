...
const io = new Server(server, {
  cors: {
    origin: process.env.NODE_ENV === 'production' ? 'https://your-frontend.onrender.com' : '*', // Update with actual frontend URL in production
  },
});
...
// Middleware
app.use(cors({ origin: process.env.NODE_ENV === 'production' ? 'https://your-frontend.onrender.com' : '*' })); // Update with actual frontend URL
